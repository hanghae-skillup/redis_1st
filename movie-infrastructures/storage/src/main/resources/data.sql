...
insert into movie (title, film_rating, genre, thumbnail_url, running_time, released_at, created_by, created_at, modified_by, modified_at) values
       ('범죄도시', 'R_15', 'ACTION', 'http://thumbnailA.png', 120, '2025-01-01', 1, '2025-01-01', 1, '2025-01-01');
...
insert into theater (name, created_by, created_at, modified_by, modified_at) values
       ('영화관01', 1, '2025-01-01', 1, '2025-01-01');
...
insert into screen (theater_id, name, created_by, created_at, modified_by, modified_at) values
        (1, '1관', 1, '2025-01-01', 1, '2025-01-01');
...
insert into schedule (theater_id, screen_id, movie_id, start_time, end_time, created_by, created_at, modified_by, modified_at) values
        (1, 1, 1, '2025-01-08 08:00:00', '2025-01-08 10:00:00', 1, '2025-01-01', 1, '2025-01-01');
...
insert into seat(`seat_number`, `axisy`, `axisx`, `created_by`, `created_at`, `modified_by`, `modified_at`) values
            ('A1', 'A', 1, 1, '2025-01-01', 1, '2025-01-01'),
            ('A2', 'A', 2, 1, '2025-01-01', 1, '2025-01-01'),
            ('A3', 'A', 3, 1, '2025-01-01', 1, '2025-01-01'),
            ('A4', 'A', 4, 1, '2025-01-01', 1, '2025-01-01'),
            ('A5', 'A', 5, 1, '2025-01-01', 1, '2025-01-01'),
            ('B1', 'B', 1, 1, '2025-01-01', 1, '2025-01-01'),
            ('B2', 'B', 2, 1, '2025-01-01', 1, '2025-01-01'),
            ('B3', 'B', 3, 1, '2025-01-01', 1, '2025-01-01'),
            ('B4', 'B', 4, 1, '2025-01-01', 1, '2025-01-01'),
            ('B5', 'B', 5, 1, '2025-01-01', 1, '2025-01-01'),
            ('C1', 'C', 1, 1, '2025-01-01', 1, '2025-01-01'),
            ('C2', 'C', 2, 1, '2025-01-01', 1, '2025-01-01'),
            ('C3', 'C', 3, 1, '2025-01-01', 1, '2025-01-01'),
            ('C4', 'C', 4, 1, '2025-01-01', 1, '2025-01-01'),
            ('C5', 'C', 5, 1, '2025-01-01', 1, '2025-01-01'),
            ('D1', 'D', 1, 1, '2025-01-01', 1, '2025-01-01'),
            ('D2', 'D', 2, 1, '2025-01-01', 1, '2025-01-01'),
            ('D3', 'D', 3, 1, '2025-01-01', 1, '2025-01-01'),
            ('D4', 'D', 4, 1, '2025-01-01', 1, '2025-01-01'),
            ('D5', 'D', 5, 1, '2025-01-01', 1, '2025-01-01'),
            ('E1', 'E', 1, 1, '2025-01-01', 1, '2025-01-01'),
            ('E2', 'E', 2, 1, '2025-01-01', 1, '2025-01-01'),
            ('E3', 'E', 3, 1, '2025-01-01', 1, '2025-01-01'),
            ('E4', 'E', 4, 1, '2025-01-01', 1, '2025-01-01'),
            ('E5', 'E', 5, 1, '2025-01-01', 1, '2025-01-01');

insert into reservation(`schedule_id`, `seat_id`, `user_id`, `reserved_at`, `version`, `created_by`, `created_at`, `modified_by`, `modified_at`) values
            (1, 1, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 2, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 3, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 4, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 5, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 6, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 7, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 8, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 9, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 10, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 11, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 12, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 13, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 14, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 15, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 16, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 17, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 18, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 19, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 20, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 21, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 22, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 23, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 24, null, null, 0, 1, '2025-01-01', 1, '2025-01-01'),
            (1, 25, null, null, 0, 1, '2025-01-01', 1, '2025-01-01');
